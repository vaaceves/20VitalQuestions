...
class Question(models.Model):
    ...
    pdf_link_eng = models.URLField(max_length=349, default='https://gls-demo-f4707.firebaseapp.com/DISCUSSIONGUIDES/DISC01/Craig_Groeschel.pdf')
    issuu_eng = models.URLField(max_length=149, default='https://e.issuu.com/anonymous-embed.html?u=onelmedia&d=craig_groeschel')
    # COMMON
